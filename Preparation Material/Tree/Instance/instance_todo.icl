...
instance == Student
where (==) a b = abs ((studentGpa a) - (studentGpa b)) < (0.3) && a.favoriteTeacher.name == b.favoriteTeacher.name
...
where toString a = (a.studentName) +++ " " +++ (toString (studentGpa a)) +++ " " +++ toString (a.favoriteTeacher.name) 
...
where 
	...
	(==) Leaf (Tree a) = False
	(==) (Tree a) Leaf = False
	(==) (Node x l r)(Node n l1 r1) = (x==n) && (l==l1) && (r==r1) 
